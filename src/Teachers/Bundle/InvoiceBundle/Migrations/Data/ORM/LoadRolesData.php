...
/**
 * Sets permissions defined in "@TeachersInvoiceBundle/Migrations/Data/ORM/CrmRoles/roles.yml" file.
 */
class LoadRolesData extends AbstractLoadAclData
{
    ...
    {
        return '@TeachersInvoiceBundle/Migrations/Data/ORM/CrmRoles/roles.yml';
    }
