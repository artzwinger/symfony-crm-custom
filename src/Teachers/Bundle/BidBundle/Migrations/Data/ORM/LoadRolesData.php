...
/**
 * Sets permissions defined in "@TeachersBidBundle/Migrations/Data/ORM/CrmRoles/roles.yml" file.
 */
class LoadRolesData extends AbstractLoadAclData
{
    ...
    {
        return '@TeachersBidBundle/Migrations/Data/ORM/CrmRoles/roles.yml';
    }
